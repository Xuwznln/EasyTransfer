...
# Redis key prefixes
class RedisKeys:
    UPLOAD_PREFIX = "easytransfer:upload:"
    FILE_PREFIX = "easytransfer:file:"
    LOCK_PREFIX = "easytransfer:lock:"
    TRAFFIC_PREFIX = "easytransfer:traffic:"
