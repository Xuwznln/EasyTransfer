...
from easytransfer.common.constants import DEFAULT_CHUNK_SIZE, AUTH_HEADER
from easytransfer.common.models import DownloadInfo
    ...
    def download_file(
        ...
        if use_cache:
            self.cache.set_file_meta(
                file_id, info.filename, info.available_size, self.chunk_size
            )
