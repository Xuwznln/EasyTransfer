...
from easytransfer.common.models import ServerInfo, FileInfo
                ...
                try:
                    ...
                    if "507" in str(e) and wait_on_quota:
                        ...
                        if total_waited >= max_wait:
                            raise RuntimeError(
                                f"Storage quota exceeded during create. "
                                f"Waited {total_waited:.0f}s."
                            ) from e
                    else:
                        raise
        else:
        ...
        while self.offset < self.file_size:
            ...
            try:
                ...
                if "507" in str(e) and wait_on_quota:
                    if total_waited >= max_wait:
                        raise RuntimeError(
                            f"Storage quota exceeded. Waited {total_waited:.0f}s, giving up."
                        ) from e
