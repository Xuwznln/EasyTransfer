...
class RoleQuota(BaseModel):
    ...
    max_storage_size: Optional[int] = PydanticField(
        None, description="Max total storage in bytes (None = unlimited)"
    )
    max_upload_size: Optional[int] = PydanticField(
        None, description="Max single file upload size in bytes"
    )
    ...
    default_retention: str = PydanticField(
        "permanent", description="Default retention policy"
    )
    default_retention_ttl: Optional[int] = PydanticField(
        None, description="Default TTL for ttl retention (seconds)"
    )
