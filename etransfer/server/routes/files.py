            ...
            for f in files_data:
                all_files.append(
                    FileInfo(
                        ...
                        total_chunks=(f["size"] + storage.chunk_size - 1) // storage.chunk_size,
                        uploaded_chunks=(f["size"] + storage.chunk_size - 1) // storage.chunk_size,
                    )
                )
            ...
            for u in uploads:
                all_files.append(
                    FileInfo(
                        ...
                        chunk_size=storage.chunk_size,
                        total_chunks=(u.size + storage.chunk_size - 1) // storage.chunk_size,
                        uploaded_chunks=(u.offset + storage.chunk_size - 1) // storage.chunk_size,
